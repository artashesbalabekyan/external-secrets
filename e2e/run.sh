...
kubectl run --rm \
  ...
  --env="BARBICAN_ENDPOINT=${BARBICAN_ENDPOINT:-}" \
  --env="BARBICAN_PROJECT_DOMAIN=${BARBICAN_PROJECT_DOMAIN:-}" \
  --env="BARBICAN_PROJECT_NAME=${BARBICAN_PROJECT_NAME:-}" \
  --env="BARBICAN_AUTH_URL=${BARBICAN_AUTH_URL:-}" \
  --env="BARBICAN_USERNAME=${BARBICAN_USERNAME:-}" \
  --env="BARBICAN_PASSWORD=${BARBICAN_PASSWORD:-}" \
  --env="BARBICAN_USER_DOMAIN_NAME=${BARBICAN_USER_DOMAIN_NAME:-}" \
